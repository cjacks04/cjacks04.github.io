...
My research has been supported by National Science Foundation ([HCC](https://www.nsf.gov/awardsearch/showAward?AWD_ID=1755628&HistoricalAwards=false)), the [Rockefeller Foundation](https://www.rockefellerfoundation.org), the [Chan Zuckerberg Initiative](https://chanzuckerberg.com), and the [UW-Madison Office of the Vice Chancellor for Research and Graduate Education](https://research.wisc.edu/funding/) and appears in top HCI venues such as *ACM Conference On Computer-Supported Cooperative Work And Social Computing*, the *Journal of the Association for Information Systems*, and *Computers in Human Behavior*. 
...
- **[Apr 2026]** I was interviewed about a project vision for advancing responsible, community-centered AI across the state of Wisconsin. Read the article: [Artificial Intelligence by Wisconsin, for Wisconsin](https://cdis.wisc.edu/artificial-intelligence-by-wisconsin-for-wisconsin/).

- **[Feb 2026]** The report from our [Computing Community Consortium](https://cra.org/ccc/) workshop report was released; I served as a co-organizer and contributing author. Read the annotated and full report here: [Grand Challenges for the Convergence of Computational and Citizen Science Research]( https://cccblog.org/2026/02/23/enhancing-scientific-capability-by-converging-ai-and-citizen-science/)

- **[Jan 2026]** Our paper 'Seeing Like a Community: Public Perceptions of Data Use in Government' has been accepted to [CHI'26](https://chi2026.acm.org/). Read the summary: [When Data Meets Policy: Why Numbers Alone Don’t Decide Public Decisions](https://medium.com/@madcollab/when-data-meets-policy-why-numbers-alone-dont-decide-public-decisions-b1fb532cb46c).

- **[Jan 2026]** Our paper 'Beyond Bias Detection: Non-Expert Auditors and Normative Reasoning in AI Oversight' has been accepted to [CSCW'26](https://cscw.acm.org/2026/). Read the summary: [How everyday people can spot risks that expert AI audits might miss](https://medium.com/uw-madison-madcollab-research/how-everyday-people-can-spot-risks-that-expert-ai-audits-might-miss-57ba44f8dd6a).