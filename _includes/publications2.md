<h2 id="publications" style="margin: 2px 0px -15px;">Publications <temp style="font-size:15px;">[</temp><a href="https://scholar.google.com/citations?user=Uf9GqRsAAAAJ" target="_blank" style="font-size:15px;">Google Scholar</a><temp style="font-size:15px;">]</temp><temp style="font-size:15px;">[</temp><a href="https://dblp.org/pid/141/4064.html)https://dblp.org/pid/141/4064.html" target="_blank" style="font-size:15px;">DBLP</a><temp style="font-size:15px;">]</temp></h2>
...
<div class="pub-row">
  ...
  <div class="col-sm-9" style="position: relative;padding-right: 15px;padding-left: 20px;">
      <div class="title"><a href="https://www.cs.jhu.edu/~yyliu/preprints/Continual_Detection_Transformer_for_Incremental_Object_Detection.pdf">Assessing the Value Orientations</a></div>
      <div class="author">Ellie Jeong, <strong>Corey Jackson</strong>, Bernt Schiele, Andrea Vedaldi, Christian Rupprecht</div>
      <div class="periodical"><em>IC&T '23: Proceedings of the 11th International Conference on Communities & Technologies</strong>, 2023.</em>
      </div>
    <div class="links">
